...
> Статус: **Этап 6 — юнит-экономика** (готово). Этапы 0–5 — готовы.
...
Этап 7 — склад и поставки: прогноз остатка, рекомендация по отгрузке, алерты
о низком остатке и триггер «конкурент в out-of-stock».
```
