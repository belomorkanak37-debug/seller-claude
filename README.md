...
> Статус: **Этап 5 — история цен** (готово). Этапы 0–4 — готовы.
...
Этап 6 — юнит-экономика: расчёт чистой прибыли (комиссия, логистика, хранение,
эквайринг, возвраты, налог) и индикатор «в плюсе/в минусе».
```
